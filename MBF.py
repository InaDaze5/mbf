...
def idteman():
	...
	if i.upper() == 'Y':
		...
		return menu()
def menu():
	cetak("!k============================================\n !m>_ !hTipe Sc : MULTI BRUTEFORCE FACEBOOK\n !m>_ !hYoutube : MAR !c \n !m>_ !hGithub  : https://github.com/RAMA-XD\n!k============================================   !p \n!k\======================/\n   !hPilih !mID!h Target..?!k\n/======================\ \n!k[!m1!k] !cSCAN PASWORD DARI DAFTAR  TEMAN !\n!k[!m2!k] !cSCAN PASWORD DARI ANGGOTA GROUP !\n!k[!m3!k] !cKELUAR/EXIT...")
